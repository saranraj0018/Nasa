...
<body>
    <div>
        ...
        <form id="studentregisterForm" action="" method="POST" enctype="multipart/form-data"
              class="mt-5 px-3">
            @csrf
            <!-- Student Name + DOB -->
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="date_of_birth" id="date_of_birth"
                           ...
                           class="w-full bg-[#D9D9D9] rounded-full px-4 py-2 mt-1 focus:outline-none focus:ring focus:ring-primary/40">
                    @error('date_of_birth') <small class="text-red-500">{{ $message }}</small> @enderror
                </div>
            </div>
            <!-- Email + Mobile -->
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="mobile_number" id="mobile_number"
                           ...
                           class="w-full bg-[#D9D9D9] rounded-full px-4 py-2 mt-1 focus:outline-none focus:ring focus:ring-primary/40">
                    @error('mobile_number') <small class="text-red-500">{{ $message }}</small> @enderror
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                    ...
                    @error('department_id') <small class="text-red-500">{{ $message }}</small> @enderror
                </div>
                <div>
                    ...
                    @error('programme_id') <small class="text-red-500">{{ $message }}</small> @enderror
                </div>
            </div>
            ...
            <div>
                ...
                <div class="bg-[#F0F0F0] rounded-3xl p-10 text-center">
                    <div id="dropArea" class="border-2 border-dashed border-primary rounded-2xl p-8 cursor-pointer">
                ...
                @error('banner_image') <small class="text-red-500">{{ $message }}</small> @enderror
            </div>
